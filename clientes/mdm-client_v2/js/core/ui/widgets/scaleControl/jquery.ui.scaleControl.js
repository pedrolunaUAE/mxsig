$.widget( "custom.scaleControl", {
      ...
      _create: function() {
        ...
        this.element
         ...
         //****** se comento la visualizacion mobile*/     
		  //if(obj.options.isMobile){
            ...
            cadena+='<div id="'+obj.id+'_pos" title="Mi ubicaci&oacute;n" class="custom-scaleControl-pos"><span class="scaleControl-sprite scaleControl-icon-pos"></span></div>';
		  //}
