...
// **************************************************************************************************************************************************************
      ...
      cadena += '     <div id="module_routing_config_axle" class="module-routing-config-axle">';
                        // Apartado de Ejes 1
      ...
      cadena += '     </div>';
                       // Ilustracion de vehiculo y remolque
      ...
      cadena += '				</div>';
                        // Boton para cambiar vehiculo
      cadena += '				<div class="module-routing-vehicle-edit fa-solid fa-pen-to-square"></div>';
      cadena += '			</div>';
                      // Separador
      ...
      cadena += '				</div>';
      cadena += '				<div class="module-routing-fuel-edit fa-solid fa-pen-to-square"></div>';
      cadena += '			</div>';
      ...
      cadena += '				</div>';
      cadena += '				<div class="module-routing-fuelYield-edit fa-solid fa-pen-to-square"></div>';
      cadena += '			</div>';
// **************************************************************************************************************************************************************
// **************************************************************************************************************************************************************
// **************************************************************************************************************************************************************
