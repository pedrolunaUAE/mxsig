...
$.widget("custom.layerManager", {
  ...
  bottomCarrucel: function () {
    ...
    for (var x in data) {
      ...
      cadena += '      <div idref="' + x + '" class="layerManager_h_c_item_img layerManager-box-sizing layerManager-color-b-80"><img style="display: block; height: inherit; width: auto; margin: 0 auto" src="' + obj.options.themeImgUrl + data[x].img + '"></div>';
...
var carrusel = document.getElementById('mdm6Layers_v_container');
