...
function getStyleDato(tipodato) {
    return function(feature) {
        ...
        switch (tipodato) {
            ...
            // Estratificación de promedio de Densidad de Población 
            case 'despobmun':
                const despob= properties.den_pob_km2; // Obtiene la Densidad de Población
            ...
            // Estratificación de promedio de Ecolaridad 
            case 'promEsco':
            ...
            // Estratificación de Edad Mediana 
            case 'munEdadMed':
                const edadMediana = properties.edadmed; 
                if (edadMediana <= 21) {
                    color = '#eaf4ff'; // Clase 1 17 - 21
                } else if (edadMediana <= 27) {
                    color = '#B6CBDF'; // Clase 2 22 - 27
                } else if (edadMediana <= 31) {
                    color = '#6D97BF'; // Clase 3 28 - 31
                } else if (edadMediana <= 35) {
                    color = '#004A8F'; // Clase 4 32 - 35
                }
        ...
        case 'pobmuntot':
            ...
            case 'munEdadMed':
                legendConfig = {
                    title: 'Edad mediana',
                    style: [
                        { label: '17 - 21 años', color: '#eaf4ff' }, // Clase 1
                        { label: '22 - 27 años', color: '#B6CBDF' }, // Clase 2
                        { label: '28 - 31 años', color: '#6D97BF' }, // Clase 3
                        { label: '32 - 35 años', color: '#004A8F' }, // Clase 4
                    ]
                }
                break;
    }
